...
while player_input_row <= 0 or player_input_row > grid_size:
    player_input_row = int(input(f"The grid is only {grid_size} by {grid_size}. Try again: "))

player_input_col = int(input("Guess a column: "))
while player_input_col <= 0 or player_input_col > grid_size:
    player_input_col = int(input(f"The grid is only {grid_size} by {grid_size}. Try again: ")) 
